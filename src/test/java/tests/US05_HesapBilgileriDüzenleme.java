...
extentTest.info
("Email adresi başarılı bir şekilde değiştirildi");
...
extentTest.info
("Biography kutusuna text girildi");
        actions.scrollByAmount(1,450);
        actions.perform();
        //Yeni password ata
        alloverCommercePage.changePasswrd1.sendKeys(ConfigReader.getProperty("kullaniciPassWord"),
Keys.TAB
,
                ConfigReader.getProperty("changePasswrd"),
Keys.TAB
,ConfigReader.getProperty("changePasswrd"),
                Keys.ENTER);
        
extentTest.info
("Password başarılı bir şekilde değiştirildi");
...
extentTest.info
("Hesap bilgileri başarılı bir şekilde değiştirildi");
    }
} 